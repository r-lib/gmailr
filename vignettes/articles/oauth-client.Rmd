...
If you are going to do auth on your local computer, the deploy that token to Posit Connect or Cloud, you need a "Desktop app".
...
## Using a non-verified, "In production" app
