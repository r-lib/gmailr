...
* Configure the OAuth consent screen for the project (or, using Google's
  ...
  - List the allowed users. This applies to a project with external user type
    and "testing" app status (as opposed to "in production").
...
My perception is that your project can exist in this state as long as the usage is extremely low, in terms of the number of unique users, which presumably will be 1 or some other very small number.
