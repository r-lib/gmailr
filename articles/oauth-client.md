...
[`gm_auth()`](https://gmailr.r-lib.org/reference/gm_auth.md). If you
...
[`gm_auth()`](https://gmailr.r-lib.org/reference/gm_auth.md) call. Click
“Continue” to obtain a user token and, hopefully, live out your
