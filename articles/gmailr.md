...
[`gm_auth()`](https://gmailr.r-lib.org/reference/gm_auth.md) explicitly
and proactively. The arguments that are most useful in practice are:
...
[`gm_profile()`](https://gmailr.r-lib.org/reference/gm_profile.md) is a
handy function to confirm that gmailr is using the intended Google
identity.
...
[`gm_mime()`](https://gmailr.r-lib.org/reference/gm_mime.md) and then
build it up from parts, using helper functions like
...
gm_date(my_msg)
#> [1] "Fri, 30 Jan 2026 10:10:21 -0600"
gm_subject(my_msg)
