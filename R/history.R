...
#' }
history <- function(start_history_id = NULL, num_results = NULL, label_id = NULL, page_token = NULL,  user_id = "me", token = gm_token()){
  page_and_trim("history", user_id, num_results, label_id, start_history_id, page_token, token = token)
}
