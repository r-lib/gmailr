...
- [`gm_auth()`](https://gmailr.r-lib.org/dev/reference/gm_auth.md) no
  longer checks for an OAuth client before calling
...
- If [`gm_auth()`](https://gmailr.r-lib.org/dev/reference/gm_auth.md)
  fails to get a token and no OAuth client has been configured, it
  silently calls
  ...
  [`gm_auth()`](https://gmailr.r-lib.org/dev/reference/gm_auth.md) tries
  one more time to get a token.

  Since the lack of an OAuth client undoubtedly remains the most common
  reason for
  [`gm_auth()`](https://gmailr.r-lib.org/dev/reference/gm_auth.md) to
  fail, its error message includes some specific content if no OAuth
...
- [`gm_oauth_client()`](https://gmailr.r-lib.org/dev/reference/gm_auth_configure.md)
  ...
  [`gm_oauth_app()`](https://gmailr.r-lib.org/dev/reference/gm_oauth_app.md).
...
- [`gm_scopes()`](https://gmailr.r-lib.org/dev/reference/gm_scopes.md)
  can now take a character vector of scopes, each of which can be an
  actual scope or a short alias, e.g., `"gmail.readonly"`, which
  identifies a scope associated with the Gmail API. When called without
  arguments,
  [`gm_scopes()`](https://gmailr.r-lib.org/dev/reference/gm_scopes.md)
  still returns a named vector of Gmail API-specific scopes, where the
  names are the associated short aliases.
...
- New
  [`gm_auth_configure()`](https://gmailr.r-lib.org/dev/reference/gm_auth_configure.md)
  and [`gm_auth()`](https://gmailr.r-lib.org/dev/reference/gm_auth.md)
...
- [`gm_body()`](https://gmailr.r-lib.org/dev/reference/gm_body.md),
  ...
  [`gm_bcc()`](https://gmailr.r-lib.org/dev/reference/accessors.md) and
  [`gm_subject()`](https://gmailr.r-lib.org/dev/reference/accessors.md)
  now automatically mark their output as UTF-8
